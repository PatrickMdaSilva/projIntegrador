...
if ($type === "update") {
  ...
  if($name == $userDao->cleanName($name) && $lastname == $userDao->cleanName($lastname)){
    ...
    $message->setMessage("Dados atualizados com sucesso", "success", "/public/index.php?pag=book&folder=views");
    ...
    if(!empty($name) && !empty($contact)){
      ...
      if (isset($_FILES["image"]) && !empty($_FILES["image"]["tmp_name"])) {
        ...
        if (in_array($image["type"], $imageTypes)) {
          ...
          imagejpeg($imageFile, "../books/" . $imageName);
        ...
        $message->setMessage("Livro adicionado com sucesso", "success", "/public/index.php?pag=book&folder=views"); 
    }else {
